...
$(".delete-button").click(function(){
	if (confirm("삭제하시겠습니까?")) {
		alert("삭제되었습니다")
		window.location.href = "../community/freeboard_delete.do?board_no=${vo.board_no}&id=${userid}"
    } else {
    }
