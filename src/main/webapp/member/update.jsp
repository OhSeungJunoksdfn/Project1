                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-6">
                           ...
                           <div class="checkout__input">
							    <p>아이디<span>*</span></p>
							    <input type="text" name="id" id="id" size="15" value="${vo.id}" readonly>
                           ...
                           <div class="checkout__input">
				            ...
				            <div class="checkout__input">
                            	<p>생년월일<span>*</span></p>
                                <input type="date" name="birthday" value="${vo.email}">
                            </div>
                            <div class="checkout__input">
                                <br><p>우편주소<span>*</span></p>
                                <input type=text id="post" name="post" class="form-control-sm" value="${vo.post}" readonly>
                            ...
                            <div class="checkout__input">
                             ...
                             <div class="checkout__input">
                                     ...
                                     <option>010</option>
						              ...
						              <input type=text name="phone2" value="${vo.phone.substring(4)}">
                             </div>
